...
def showLOLBuild(ChampionName):
    ...
    embed.add_field(name = "---------------------------------------------", value = GameChamTier + " 티어", inline = False)
    embed.add_field(name = "추천 소환사 주문", value = GameChamSpell1 + ", " + GameChamSpell2)
    #embed.set_thumbnail(url = "https://opgg-static.akamaized.net/images/lol/champion/" + LOLCharToEng(ChampionName) + ".png")
